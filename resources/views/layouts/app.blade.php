                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            <div class="hidden fixed top-0 right-0 px-0 py-0 sm:block">
                                @if (Route::has('login'))
                                    <a class="btn btn btn-outline-success btn-sm" href="{{ route('login') }}">{{ __('Iniciar sesión') }}</a>
                                    
                                @endif

                                @if (Route::has('register'))
                                    <a class="btn btn btn-outline-success btn-sm" href="{{ route('register') }}">{{ __('Registrarse') }}</a>
                                @endif
                            </div>
                        @else
